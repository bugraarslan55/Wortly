...
const styles = StyleSheet.create({
  ...
  previewBadge: { marginTop: Spacing.md, paddingHorizontal: Spacing.md, paddingVertical: Spacing.sm, borderRadius: BorderRadius.full, backgroundColor: Colors.surfaceContainer },
  previewBadgeText: { fontSize: 12, fontWeight: '600', color: Colors.onSurfaceVariant },
  answerArea: { width: '100%', flexShrink: 0, paddingHorizontal: Spacing.marginMain, paddingTop: Spacing.sm, paddingBottom: Spacing.md, gap: Spacing.sm, backgroundColor: Colors.warmWhite },
